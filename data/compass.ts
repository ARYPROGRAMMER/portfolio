...
export const compassPaths: CompassPath[] = [
  {
    ...
    body: "I graduate from IIIT Ranchi in 2027 and I'm open to new-grad software roles now. I've already shipped production code at four companies — one of them full-time — so the ramp-up is short.",
    points: [
      ...
      { label: "Proof", value: "53% build-time cut in week two" },
    ],
  ...
  },
  {
    ...
    body: "I've taken products from an empty repository to production — web app, Flutter client, payments, auth gateways and the deployment pipeline underneath. If the hard bit is that nobody wants to own the whole vertical slice, that's the bit I want.",
    points: [
      { label: "Built from zero", value: "pelton.ai, end to end" },
      { label: "Mobile", value: "Flutter + BLoC, clean architecture" },
      { label: "Comfortable with", value: "Gateways, Stripe, Cloudflare" },
