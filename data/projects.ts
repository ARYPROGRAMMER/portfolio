...
export const projects: Project[] = [
  ...
  },
  {
    ...
    note: "Written because my own student life was a mess. Nuclia-backed RAG over your own notes, real-time backend on Convex.",
    stack: ["Next.js 15", "Convex", "Nuclia RAG", "CopilotKit", "Gemini"],
    stars: 5,
    forks: 2,
